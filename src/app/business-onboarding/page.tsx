...
export default function BusinessOnboardingPage() {
  ...
  const totalSteps = 7; // Added step for multi-business/branch management
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-white mb-4">
          {onboardingState.isAddingNewBusiness
          ...
          return (
            <Card
              ...
              className={`cursor-pointer transition-all duration-300 hover:scale-105 border-2 ${
                currentBusiness.type === type.id
                  ? "border-[#05BBC8] bg-[#05BBC8]/10 shadow-lg shadow-[#05BBC8]/20"
                  : "border-gray-700 bg-gray-900 hover:border-gray-600"
              }`}
            ...
            >
              <CardContent className="p-8 text-center">
                ...
                {currentBusiness.type === type.id && (
                  <Badge className="bg-[#05BBC8] text-black">Selected</Badge>
                )}
              </CardContent>
            </Card>
          );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div className="text-center lg:text-left">
            ...
            <p className="text-gray-400">
              Provide the essential details customers need to find and contact
              you
            </p>
          </div>
        ...
        {currentStep < 7 && (
          <div className="flex items-center justify-between">
            ...
            <Button
              onClick={handleNext}
              disabled={!canProceed()}
              className="bg-[#05BBC8] hover:bg-[#049aa5] text-black font-semibold"
            >
              {currentStep === 6 ? (
                <>
