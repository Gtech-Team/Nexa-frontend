    ...
    <section className="relative pt-16 sm:pt-20 pb-12 sm:pb-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 leading-tight">
          ...
          <br />
          <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl">growth platform</span>
        </h1>
        ...
        <div className="relative">
          ...
          <p className="text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base">Add your brand to the conversation.</p>
        </div>
